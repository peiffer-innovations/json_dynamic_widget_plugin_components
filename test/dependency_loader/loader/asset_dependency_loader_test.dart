...
void main() {
  group('DirAssetPathResolver', () {
    ...
    test('should resolve with yaml path in case of passing that ext via constructor', () {
      // given
      const basePath = 'path/to/base';
      const ext = '.yaml';
    ...
    test('should resolve with path that takes into account extension by dependency name', () {
      // given
      const basePath = 'path/to/base';
      const ext = '.json';
